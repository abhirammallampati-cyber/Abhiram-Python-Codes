...
# Decide between outdoor and indoor activity
if temperature < 20:
...
is_raining = is_raining.lower() # Changes text to lowercase so "Yes" works
 
# Add a rain reminder only if it is raining
if is_raining == "yes":
    print("Choose an indoor activity or carry an umbrella!")
 
# Ask for the homework time
homework_time = int(input("Enter homework time in minutes: "))
 
# Decide whether study break is needed
if homework_time > 60:
    needs_break = "yes"
...
# Ask whether there is free time
has_free_time = input("Do you have free time today? (yes/no): ")
has_free_time = has_free_time.lower()
 
# Decide between hobby time and planning time
...
# Print the final activity summary 
